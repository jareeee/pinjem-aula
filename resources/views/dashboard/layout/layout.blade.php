...
<html lang="en">
  <head>
    ...
    <title>Pinjem Aula | Dashboard</title>
...
<header class="navbar navbar-dark sticky-top navbar-dark bg-dark flex-md-nowrap p-0 shadow">
    ...
    <div class="row">
        ...
        <div class="position-sticky pt-3">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('dashboard/payment') ? 'active-link' : '' }} " aria-current="page" href="/dashboard/payment">
            ...
            @can('admin')
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('dashboard/admin*') ? 'active-link' : '' }} " href="/dashboard/admin">
